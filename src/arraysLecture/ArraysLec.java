...
//fill likely uses overloaded methods for different data types
//        public static datatype[] arrays(datatype[] arr, start, stop, data) {
//            for(datatype i = start; i < stop; i++) {
//            arr[i] = data;
//            }
//        }


//        public static datatype[] arrays(datatype[] arr, data) {
//            for(datatype i = 0; i < arr.length; i++) {
//            arr[i] = data;
//            }
//        }
...
//        Arrays.fill(twoBadgers, 4, 5, "not a badger");
//        System.out.println(Arrays.toString(twoBadgers));
//
//        int[] badgerArray2 = new int[4];
//        Arrays.fill(badgerArray2, 1);
//
//        int[] twoBadgers2 = Arrays.copyOf(badgerArray2, 5);
//        Arrays.fill(twoBadgers2, 4, 5, 1);
//        System.out.println(Arrays.toString(twoBadgers2));
