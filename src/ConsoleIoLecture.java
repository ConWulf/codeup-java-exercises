...
//int favNum = 42;
//System.out.printf("My favorite number is %d %n new line", favNum);
...
//String shopping = "leeks";
//String addToList = "carrots";
//System.out.printf("I need %s %n and %S", shopping, addToList);
...
//        System.out.printf("I need %s and %S", shopping, addToList);
        // >>>> Multiple Variables
...
//int myInteger = 42;
//String myStr = "The answer is:";
//
//System.out.printf("According to HHGttG, %s %s", myStr, myInteger);


        //TODO:
        // (1) Print using printf(), multiple variables, and placeholders

//int numOfGalxyTypeFound = 34;
//String typeOfGalaxy = "ring";
//System.out.printf("We have found %d %s galaxies so far", numOfGalxyTypeFound, typeOfGalaxy);
...
//String firsName = userInput.next();
...
//
//    String favQuote = userInput.nextLine();
